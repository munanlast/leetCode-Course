...
global.define = function (id, deps, factory) {
    ...
    function(module, relativeId, callback) {
		// console.log(module)
		...
		if(relativeId.startsWith('vs/') || relativeId.startsWith('./vs/')){
			relativeId = relativeId.replace('vs/', '/');	
			relativeId = path.join(__dirname, relativeId);
		}
